...
- 목록 조회 메서드는 `list{리소스}s` 형식으로 작성한다.
- 단건 조회 메서드는 `get{리소스}ById` 또는 `get{리소스}By{조건}` 형식으로 작성한다.
- 생성 메서드는 `create{리소스}` 또는 `add{리소스}` 형식으로 작성한다.
- 수정 메서드는 `update{리소스}` 형식으로 작성한다.
- 삭제 메서드는 `delete{리소스}` 형식으로 작성한다.
